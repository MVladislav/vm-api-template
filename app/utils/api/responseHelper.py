...
def responseHandler(params: List[ResponseHandlerObject], code: int = 200) -> ResponseHolderObject:
    """
    ...
    result: ResponseHolderObject = ResponseHolderObject(httpCode=code, msg=ResponseSchema())
...
def responseMsgHandler(argument: ErrorTypeEnum) -> str:
    """
